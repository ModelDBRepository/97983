...
modeleNpop.app contains the executable Code (modeleNpop.exe) for the
above model.

It needs Openstep Enterprise (OSE) for Windows for running under
Windows. See "..\aSimulationSnapshot.tif"

The source code (..\src) can be imported in Linux GNUSTEP with minor
