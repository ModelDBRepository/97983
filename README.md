...
*Journal:* _J Clin Neurophysiol._ 2005 Oct;22(5):343-56.
...
[http://perso.univ-rennes1.fr/fabrice.wendling/](http://perso.univ-rennes1.fr/fabrice.wendling/)

---

## Notes about the directories/files included in this archive:

- In the executable directory (exe), the `modeleNpop.app` directory contains the executable Code (`modeleNpop.exe`) for the above model.

- It needs Openstep Enterprise (OSE) for Windows for running under Windows. See "aSimulationSnapshot.jpg" for screenshot collection:

  ![a simulation snapshot](aSimulationSnapshot.jpg)
